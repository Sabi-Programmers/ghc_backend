...
CREATE TABLE "Contants" (
    ...
    "gold" DOUBLE PRECISION NOT NULL DEFAULT 0.00,
    "diamond" DOUBLE PRECISION NOT NULL DEFAULT 0.00,
    "bronzeRefBonus" DOUBLE PRECISION NOT NULL DEFAULT 0.00,
    "goldRefBonus" DOUBLE PRECISION NOT NULL DEFAULT 0.00,
    "diamondRefBonus" DOUBLE PRECISION NOT NULL DEFAULT 0.00,
    ...
    "bronzeThreshold" DOUBLE PRECISION NOT NULL DEFAULT 0.00,
    "goldThreshold" DOUBLE PRECISION NOT NULL DEFAULT 0.00,
    "diamondThreshold" DOUBLE PRECISION NOT NULL DEFAULT 0.00,
    "leaderCycleThreshold" DOUBLE PRECISION NOT NULL DEFAULT 0.00,
    "salesIncomeThreshold" DOUBLE PRECISION NOT NULL DEFAULT 0.00,
    "usdRate" DOUBLE PRECISION NOT NULL DEFAULT 0.00,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
