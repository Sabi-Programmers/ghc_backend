...
const accountUnblockedMailTemp = (fullName) => `<!DOCTYPE html>
            <html>
                <head>
                    <meta charset="UTF-8" />
                    <title>Account Unblocked Notification</title>
                </head>
                <body
                    style="
                        font-family: Arial, sans-serif;
                ...
                >
                    ...
                    >
                        ...
                        <div style="padding: 20px">
                            <p>Hi ${fullName},</p>
                            <p>
                                We are pleased to inform you that your account on Grand Health Cycle has been unblocked. You can now log in and continue using our services without any restrictions.
                            </p>
                            <p>
                                We apologize for any inconvenience this may have caused and appreciate your understanding and cooperation during this process.
                            </p>
                            <p>
                                If you have any questions or need further assistance, please do not hesitate to contact our support team at <a href="mailto:support@grandhealthcycle.com" style="color: #888888; text-decoration: none">support@grandhealthcycle.com</a> or call us at [Support Phone Number].
                            </p>
                            <p>
                                Thank you for being a valued member of Grand Health Cycle.
                            </p>
                            <p>
                                Best regards,<br/>
                                Grand Health Cycle Support Team
...
const adminOTPMailTemp = (username, otp) => `<!DOCTYPE html>
            <html>
                <head>
                <meta charset="UTF-8" />
                <title>OTP Email</title>
                ...
                <h2 style="text-align: center;">Grand Health Cycle</h2>
                    ...
                    <p>Hi ${username},</p>
                    <p>
                         To complete this the action, please use the following One-Time Password
                        (OTP):
                    </p>
                    <div
                        style="
